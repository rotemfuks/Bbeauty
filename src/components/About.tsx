...
export function About() {
  return (
    <div>
      <h1 className={styles.aboutTitle}>Bbeauty</h1>
      ...
      <div className={styles.container}>
        ...
        <div className={styles.paragraph}>
          Embrace the art of making a lasting impression with business cards
          that beautifully blend style and functionality. Each card is
          meticulously crafted to showcase your brand's essence, while providing
          essential contact information that opens doors to new opportunities.
          With a seamless browsing experience, you can effortlessly explore our
          selection of modern and chic designs, filtering by your preferences to
          find the perfect match. Personalize your chosen card with your brand's
          logo, colors, and details to create a powerful visual representation
          of your cosmetics business.
        </div>
        <div className={styles.paragraph}>
